...
session_start();
	...
	echo '<script type="text/javascript">
			window.onload = function () { alert("OTP Send Succesfully"); } 
			</script>';	
	}
    ...
    $mail->Host       = 'smtp.gmail.com';                     //Set the SMTP server to send through
        ...
        $mail->Body    = "You have succesfully registered with CertificUP" 
                          ;
        //$mail->AltBody = 'This is the body in plain text for non-HTML mail clients';

        $mail->send();
header("Location: login.php?Message=" . urlencode($user_name));
		die;
	}
	else{
		header("Location: signup.php?Message=" . urlencode($user_name));
		die;
	}
		...
		<div class="screen__content">
			...
			<h2>OTP VERFICATION</h2>
				<div class="login__field">
					...
					<input required id="text" type="text" name="otp" class="login__input" placeholder="4 Digit OTP Number"></input>
				</div>
				<input id="button" type="submit" value="Verify" name="verify">
